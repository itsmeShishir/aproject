...
const ContactUsComponent = () => {
  return (
    <section className="mx-auto w-full max-w-screen-2xl bg-white py-20 lg:py-[120px] overflow-hidden relative z-10">
            ...
            <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
              <form>
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full p-3 text-white transition border bg-red-500 rounded border-primary bg-primary hover:bg-opacity-90"
                  >
                    Send Message
                  </button>
                </div>
