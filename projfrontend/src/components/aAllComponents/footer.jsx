...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp relative z-10  pt-20 lg:pt-[120px]"
        data-wow-delay=".15s"
      >
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:">
              <div className="mb-10 w-full">
                ...
                <div className="-mx-3 flex items-center">
                  <a href="javascript:void(0)" className="px-3 text-[#dddddd] ">
                    <svg
                      width="10"
                      height="18"
                      viewBox="0 0 10 18"
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-10 w-full">
                <h4 className="mb-9 text-lg font-semibol">About Us</h4>
                <ul>
                  <li>
                    <a
                      href="javascript:void(0)"
                      className="mb-2 inline-block text-base leading-loose hover:text-primary"
                    >
                      Home
                    </a>
                  </li>
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg: xl:w-2/12">
              <div className="mb-10 w-full">
                <h4 className="mb-9 text-lg font-semibol">Features</h4>
                <ul>
                  <li>
                    <a
                      href="javascript:void(0)"
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg: xl:w-2/12">
              <div className="mb-10 w-full">
                <h4 className="mb-9 text-lg font-semibol">Our Products</h4>
                <ul>
                  <li>
                    <a
                      href="javascript:void(0)"
              ...
              <div className="w-full px-4 md:w-2/3 lg:w-1/2">
                <div className="my-1">
                  <div className="-mx-3 flex items-center justify-center md:justify-start">
                    <a
                      href="javascript:void(0)"
                      className="px-3 text-base hover:text-primary"
                    >
                      Privacy policy
                    </a>
                    <a
